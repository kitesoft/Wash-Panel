...
class EarningsWidget extends StatefulWidget {
  @override
  State createState() {
    return new _EarningsState();
  }
}

class _EarningsState extends State<EarningsWidget> {
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Expanded(
            ...
            children: <Widget>[
              new DataCard(
                  title: Strings.earning,
                  description: Strings.blahBlah,
                  icon: new Container(),
                  color: Colors.blue[600]),
              new ChartCard(title: Strings.loremIpsum, type: null, seriesList: null),
              new SeeAllCard(
